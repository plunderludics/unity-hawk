...
[ExecuteInEditMode]
public class CRTMaterial: MonoBehaviour
{
    ...
    public float scanlineSize = 800f;
    public float scanlineStrength = 0.04f;
    ...
    private int _ScanlineSpeed;
    private int _ScanlineSize;
    private int _ScanlineStrength;
    ...
    private void OnEnable()
    {
        ...
        _ScanlineSpeed = Shader.PropertyToID("_ScanlineSpeed");
        _ScanlineSize = Shader.PropertyToID("_ScanlineSize");
        _ScanlineStrength = Shader.PropertyToID("_ScanlineStrength");
